 ...
 ****************************************************************************/
	...
	$Q_Check	= "SELECT * FROM ".PACKAGE."  ORDER BY `package_id` ASC  ";
	...
	$Q_Check1	= "SELECT * FROM ".PACKAGE." ORDER BY `package_id` ASC";
...
<div class="wrap">
	...
	<?php include("sidenav.php"); ?>			
		<div id="main">
			...
			<div class="full_w">
				<div class="h_title">View Product Category</div>
				 <?php
					  # Display the Result(Status) 
					  if($rflag == "success") 
					  { 
						  if($rType == "add")
							$rDisp	=	"Product Category Details Successfully Added";
						  elseif($rType == "deactive")
							$rDisp	=	"Product Category Details Successfully Actived";
						  elseif($rType == "active")
							$rDisp	=	"Product Category Details Successfully DeActived";
						  elseif($rType == "check")
							$rDisp	=	"Product Category Details Successfully turns to Popular";
						  elseif($rType == "uncheck")
							$rDisp	=	"Product Category Details Successfully cancel from Popular";
						  elseif($rType == "delete")
							$rDisp	=	"Product Category Details Deleted Successfully";
						  elseif($rType == "edit")
							$rDisp	=	"Product Category Details Edited Successfully";
...
<!--							<th scope="col" align="center">Package Duration</th>-->
							<th scope="col" align="center">Category Name</th>
					...
					<?php
						...
						<tr>
							...
							<td align="center"><?php if($F_Check['package_st'] == "1") { ?><a style="color:#000000;text-decoration:none;" href="viewassortmentcategory.php?task=view&amp;flag=active&amp;id=<?php echo $F_Check['package_id'];?>" ><?php echo $sta; ?></a> <?php } else { ?> <a style="color:#000000;text-decoration:none;" href="viewassortmentcategory.php?task=view&amp;flag=deactive&amp;id=<?php echo $F_Check['package_id'];?>" ><?php echo $sta; ?></a> <?php } ?> </td>
							<td align="center">
								<a href="assortmentcategory.php?task=edit&amp;mid=<?php echo $F_Check['package_id'];?>&amp;page=<?php echo $page;?>" class="table-icon edit" title="Edit"></a>
								<a href="#" class="" title="Archive">&nbsp;</a>								
								<a href="viewassortmentcategory.php?task=view&amp;flag=delete&amp;id=<?php echo $F_Check['package_id'];?>&amp;page=<?php echo $page;?>" onclick="return calldel('Do you want to delete this Assortment Category details?');" class="table-icon delete" title="Delete"></a>
							</td>
						</tr>
						<?php } } else {?> 
						<tr>
							<td colspan="5" align="center"><h2>Category List Not Found</h2></td>
						</tr>
						<?php } ?>
					</tbody>
