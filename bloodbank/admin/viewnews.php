...
<div class="wrap">
	...
	<?php include("sidenav.php"); ?>			
		<div id="main">
			<div class="full_w">
				<div class="h_title">View News</div>
				 <?php
					  # Display the Result(Status) 
					  if($rflag == "success") 
					  { 
						  if($rType == "add")
							$rDisp	=	"News Details Successfully Added";
						  elseif($rType == "deactive")
							$rDisp	=	"News Details Successfully Actived";
						  elseif($rType == "active")
							$rDisp	=	"News Details Successfully DeActived";
						  elseif($rType == "check")
							$rDisp	=	"News Details Successfully turns to Popular";
						  elseif($rType == "uncheck")
							$rDisp	=	"News Details Successfully cancel from Popular";
						  elseif($rType == "delete")
							$rDisp	=	"News Details Deleted Successfully";
						  elseif($rType == "edit")
							$rDisp	=	"News Details Edited Successfully";
				...
				<table>
					<thead>
						<tr>
						  ...
						  <th width="139" align="center" scope="col">News Title</th>
							<th width="196" align="center" scope="col">News Dec</th>                            
