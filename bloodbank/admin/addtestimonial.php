...
<div class="wrap">
	...
	<?php include("sidenav.php"); ?>			
		<div id="main">
			...
			<div class="full_w">
				<div class="h_title">Add Testimonial</div>
				<form action="addtestimonial.php" method="post" enctype="multipart/form-data" name="frm_accountinfo" onsubmit="return setting_validation();">
					...
					<div class="element">
						...
						<input id="testimonial_img" name="testimonial_img" class="text" type="file" value="<?php echo $ans['testimonial_img']; ?>" /><br /><br />
						<?php if($ans['testimonial_img']!="") { ?>                       
						<img src="<?php echo $filepath.$ans['testimonial_img']; ?>" width="80" />
						<?php } ?>
					</div>
					<div class="element">
